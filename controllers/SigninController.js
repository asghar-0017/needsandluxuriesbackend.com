...
console.log(user)
  ...
  const login = async (req,res)=>{
    try{
      const user = await ClientModel.findOne({email:req.body.email},{password:req.body.password})
...
const UpdatePassword = async(req,res)=>{
  ...
  module.exports = { createclient,login,forgetpassword,PasswordForm,UpdatePassword };